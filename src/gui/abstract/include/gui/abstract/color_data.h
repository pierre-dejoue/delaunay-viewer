...
static constexpr ColorData COLOR_DATA_TRANSPARENT     {0.f, 0.f, 0.f, 0.f};

inline constexpr ColorData COLOR_DATA_GRAY(float lum) { lum = stdutils::clamp(lum, 0.f, 1.f); return ColorData{ lum, lum, lum, 1.f}; }
